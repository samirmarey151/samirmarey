<?php 
ob_start();
define('API_KEY','5588893394:AAHwDW5yg5xvo5Vjeq1tDQYV7dxcCBMqlF8');
...
$get_files = file_get_contents('SourceBot.php'); $get_done = file_get_contents('infos/explode.php');
$done = explode("\n", $get_done);
...
<a href='https://t.me/Rmziat_Mrahq'> رشق </a> 
<a href='https://t.me/SEMO151'>مالتي</a> 
<a href='https://t.me/EITHON151'>ملفات خدميه  </a> 
</html>";

$ch = "@SEMO151";//هنا تخلي معرف قناتك 
$admin = 5492903154;//هنا تخلي ايديك
$urls="https://botteletelebotbb.cf/BOTATM";//هنا تخلي رابط الاستضافه مالتك 
$alsh = "-1791037398"; #ايدي قناتك
...
'reply_markup'=>json_encode([ 
      'inline_keyboard'=>[  
[['text'=>"مساعده المطورين",'url'=>"https://t.me/Alstorh1"]],
]])]);return false;}
...
'chat_id'=>$chat_id,
'text'=>"
اهلا بك في بوت مصنع بوتات حماية .📡
...
تواصل المــطور :~ @SEMO151
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'™ أصنع بوتك الان','callback_data'=>'addbot'],['text'=>'™ احذف بوتك الان','callback_data'=>'delete']],
[['text'=>'📡 قناة البوت 📡','url'=>'https://t.me/Allm_Telegram']],
[['text'=>'كيف اصنع بوت؟','callback_data'=>'help'],['text'=>'📮 تواصل','url'=>'https://t.me/Twasl9Bot']],
[['text'=>'📬ملفات بوتات','url'=>'https://t.me/Alstorh1']],],])]);}
...
mkdir("SourceBot/$from_id");
file_put_contents("SourceBot/$from_id/info.php",$text . "\n" . $from_id);
file_put_contents("SourceBot/$from_id/bot.php", $get_files);
file_put_contents("info.txt",$from_id ."\n",FILE_APPEND);
file_put_contents("SourceBot/$from_id/chat.php", $from_id . "\n");
file_put_contents("SourceBot/$from_id/index.html","$index");
file_get_contents("https://api.telegram.org/bot$text/setwebhook?url=$urls/SourceBot/$from_id/bot.php");}
file_put_contents("SourceBot/index.html","$index");
file_put_contents("zreaf/SourceBot/$from_id","$index");
...
[['text'=>'™ أصنع بوتك الان','callback_data'=>'addbot'],['text'=>'™ احذف بوتك الان','callback_data'=>'delete']],
[['text'=>'📡 قناة البوت 📡','url'=>'https://t.me/Allm_Telegram']],
[['text'=>'كيف اصنع بوت؟','callback_data'=>'help'],['text'=>'📮 تواصل','url'=>'https://t.me/iTwasl9Bot']],
[['text'=>'📬 ملفات بوتات','url'=>'https://t.me/Alstorh1']],],])]);}
if($data == 'home'){
bot('editMessageText',['chat_id'=>$chat_id2,'message_id'=>$message_id,'text'=>"
اهلا بك في بوت مصنع بوتات حماية .📡
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
•[ أضغط لمراسله المطور](https://t.me/SEMO151)   
•[ أضغط هنا وتابع جديدنا](https://t.me/EITHON151)

",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>'الصفحة الرئيسية 🏠️','callback_data'=>'home']],[['text'=>'📡 - إضغط هنا وتابع جديدنا - ','url'=>'https://t.me/Allm_Telegram']],],])]);}
//========================================================================
...
$get_token = file_get_contents("SourceBot/$chat_id2/info.php");
...
unlink("SourceBot/$chat_id2/bot.php");
unlink("SourceBot/$chat_id2/info.php");}
